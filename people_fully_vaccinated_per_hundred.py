...
sr_one = jp_df['people_fully_vaccinated_per_hundred'] # people_fully_vaccinated_per_hundred
sr_two = kr_df['people_fully_vaccinated_per_hundred'] # people_fully_vaccinated_per_hundred
...
ax.legend(loc = 'best')
ax.set_title("Ratio of people_fully_vaccinated_per_hundred in Korea and Japan")
ax.set_xlabel("date")
