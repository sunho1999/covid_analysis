...
sr_one = jp_df['people_vaccinated_per_hundred'] # jp의 total_cases_per_million
sr_two = kr_df['people_vaccinated_per_hundred'] # kr의 total_cases_per_million
...
ax.legend(loc = 'best')
ax.set_title("Ratio of people_vaccinated_per_hundredof covid in Korea and Japan")
ax.set_xlabel("date")
